        ...
        <div className="flex shrink-0 items-center gap-2">
          {quote.image_url ? (
            <button
              ...
              className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-stone-900/10 bg-white/45 text-stone-800 transition hover:bg-white/70"
              aria-label="View quote image"
            >
              <svg
                viewBox="0 0 24 24"
                fill="none"
